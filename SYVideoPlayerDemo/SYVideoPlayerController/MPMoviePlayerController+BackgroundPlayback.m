...
@implementation MobilePlayerViewController (BackgroundPlayback)
...
+ (void) load
{
	...
	dispatch_async(dispatch_get_main_queue(), ^{
		...
		[defaultCenter addObserver:self selector:@selector(backgroundPlayback_moviePlayerNowPlayingMovieDidChange:) name:@"MobilePlayerStateDidChange" object:nil];
...
static __weak MobilePlayerViewController *currentMoviePlayerController;

+ (void) backgroundPlayback_moviePlayerNowPlayingMovieDidChange:(NSNotification *)notification
{
	currentMoviePlayerController = (MobilePlayerViewController *)notification.object;
}
